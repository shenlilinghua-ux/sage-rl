...
main_model="/path/to/your_data/models/DeepScaleR-1.5B-Preview"
...
validate_first=false # whether valide the beam search results before use.
...
project_name="beam_deepscale_1.5b_dapo_math_math500"
...
experiment_name="lr_${lr}_no_boost_adv_${generation_mode}_token_constrain_sort_${enable_sort}_gs_${group_size}_width_${beam_width}_require_${required_completions}_lp_${length_penalty}_vf_${validate_first}_ab_${apply_ablation}_${suffix}"
...
PYTHONUNBUFFERED=1 python3  -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.token_constrain=$token_constrain \
