...
experiment_name="rl_${rl}_no_boost_adv_${generation_mode}_sort_${enable_sort}_gs_${group_size}_width_${beam_width}_require_${required_completions}_lp_${length_penalty}_vf_${validate_first}_ab_${apply_ablation}_${suffix}"
...
PYTHONUNBUFFERED=1 python3  -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.optim.lr=$rl \
