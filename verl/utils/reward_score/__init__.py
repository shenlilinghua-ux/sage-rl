...
def default_compute_score(
    ...
    # TODO, let reward manager recognize the datasource dapo_math
    elif data_source == "math_dapo" or data_source.startswith("aime") or "dapo_math":
        from verl.utils.reward_score  import math_dapo

        res = math_dapo.compute_score(solution_str, ground_truth)  # 不接受数据源
    elif data_source in [
        "numina_aops_forum",
